...
describe('sectionify', () => {
	it('should wrap flat markdown with headings into sections', async () => {
...
Final content`
		...
		const nestedSection = section1.children[2]
...
Content 2`
	...
	it('should handle markdown with content before first heading', async () => {
...
Content`
	...
	it('should handle multiple root level sections', async () => {
